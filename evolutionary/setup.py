...
setup(
    ...
    long_description='This package includes generic classes for evolutionary computation in a generational environment.'
                     ' Crossover and Mutation happens on the argument (A) level, whilst the fitness is evaluated on '
                     'the result (R) level. '
                     'SolutionCandidates are created by a SolutionCreator, their representation is split into '
